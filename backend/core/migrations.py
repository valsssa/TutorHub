...
class MigrationManager:
    ...
    def apply_migration(self, version: str, filepath: Path) -> None:
        ...
        try:
            ...
            self.db.execute(insert_sql, {"version": version, "description": description, "checksum": checksum})
...
def run_startup_migrations(db: Session) -> None:
    ...
    try:
        ...
        raise RuntimeError(f"Database migration failed. Application cannot start. Error: {e}") from e
