...
class TestTutorAvailabilityE2E:
    ...
    def test_sunday_only_availability_shows_only_sunday_slots(
        self, client, db_session, tutor_user, student_token
    ):
        """
        ...
        saved = db_session.query(TutorAvailability).filter(
            TutorAvailability.tutor_profile_id == tutor_profile.id
        ).all()
    ...
    def test_monday_only_availability_shows_only_monday_slots(
        self, client, db_session, tutor_user, student_token
    ):
        """
    ...
    def test_no_availability_returns_empty_slots(
        self, client, db_session, tutor_user, student_token
    ):
    ...
    def test_multiple_days_returns_correct_days_only(
        self, client, db_session, tutor_user, student_token
    ):
        """
