...
This file provides guidance to codex when working with code in this repository. - just make all fixed and working properly - also dont write reports and etc - just make all fixed and working properly
...
- `.cursorrules` - Detailed LLM development rules
- `OPTIMIZATION_SUMMARY.md` - Security and performance improvements
