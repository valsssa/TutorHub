        ...
        <div className="flex-1 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 relative overflow-hidden p-6 shadow-inner">
            <div className="absolute top-4 left-4 flex gap-2 bg-slate-100 dark:bg-slate-800 p-2 rounded-lg border border-slate-200 dark:border-slate-700 z-10">
                <button 
                    ...
                    className={`p-2 rounded transition-colors ${activeTool === 'pen' ? 'bg-emerald-100 text-emerald-600 dark:bg-emerald-900/50 dark:text-emerald-400' : 'hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-400'}`}
                    title="Pen Tool"
                >
                    <PenTool size={20} />
                </button>
                <button 
                    ...
                    className={`p-2 rounded transition-colors ${activeTool === 'share' ? 'bg-emerald-100 text-emerald-600 dark:bg-emerald-900/50 dark:text-emerald-400' : 'hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-400'}`}
                    title="Share Screen"
                >
                    <Share size={20} />
                </button>
                <button 
                    ...
                    className={`p-2 rounded transition-colors ${activeTool === 'menu' ? 'bg-emerald-100 text-emerald-600 dark:bg-emerald-900/50 dark:text-emerald-400' : 'hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-400'}`}
                    title="More Options"
                >
