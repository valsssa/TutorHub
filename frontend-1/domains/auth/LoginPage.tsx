...
import { MOCK_STUDENT, MOCK_TUTOR_USER, MOCK_ADMIN, MOCK_OWNER } from '../../constants';
...
export const LoginPage: React.FC<LoginPageProps> = ({ onLogin, setNotification }) => {
    ...
    const handleVerificationSubmit = (e: React.FormEvent) => {
        ...
        setTimeout(() => {
            ...
            // Create a mock new user based on signup data
            const newUser: User = {
                id: `u-${Date.now()}`,
                name: signupName,
                role: signupRole,
                avatarUrl: `https://ui-avatars.com/api/?name=${encodeURIComponent(signupName)}&background=random`,
                balance: 0,
                earnings: 0,
                savedTutorIds: []
            };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 relative overflow-hidden transition-colors duration-200">
           ...
           {view === 'VERIFY_EMAIL' && (
               <div className="animate-in slide-in-from-right duration-300 text-center">
                   ...
                   <p className="text-sm text-slate-500 mt-6">
                       Didn't receive the code? <button className="text-emerald-600 font-medium hover:underline">Resend</button>
                   </p>
               ...
               <div className="animate-in zoom-in duration-300 text-center">
                   ...
                   <div className="space-y-3">
                       ...
                       <div className="text-sm text-slate-500">
                           Didn't receive the email? <button className="text-emerald-600 font-medium hover:underline">Click to resend</button>
                       </div>
                       <button 
                           onClick={() => setView('LOGIN')}
