...
export const TutorProfilePage: React.FC<TutorProfilePageProps> = ({ 
    tutor, onBack, onBook, onBookSlot, onMessage, isOwnProfile = false, onEdit, onViewFullSchedule, onToggleSave, isSaved
}) => {
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
                            <div className="flex items-center gap-4 w-full sm:w-auto">
                                <div className="flex gap-1">
                                    <button className="p-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-lg text-slate-500 dark:text-slate-400 transition-colors">
                                        <ChevronLeft size={20}/>
                                    </button>
                                    <button className="p-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-lg text-slate-500 dark:text-slate-400 transition-colors">
                                ...
                                <span className="font-bold text-slate-900 dark:text-white text-sm sm:text-base">
                                    {scheduleDays[0].toLocaleDateString('en-US', { month: 'short', day: 'numeric' })} – {scheduleDays[6].toLocaleDateString('en-US', { day: 'numeric', year: 'numeric' })}
                                </span>
                            </div>
