                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-start gap-6 sm:gap-8">
                                ...
                                <div className="pt-2 space-y-3">
                                    ...
                                    <button 
                                        onClick={() => fileInputRef.current?.click()}
                                        className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-lg text-sm font-bold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors shadow-sm"
                                    >
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-sm text-slate-700 dark:text-slate-300">
                                            {isFacebookConnected ? 'Connected to Facebook' : 'Not connected to Facebook account'}
                                        </span>
                                    </div>
                                    <button 
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-sm text-slate-700 dark:text-slate-300">
                                            {isGoogleConnected ? `Connected as ${firstName} ${lastName.charAt(0)}.` : 'Not connected to Google'}
                                        </span>
                                    </div>
                                    <button 
                    ...
                    <div className="space-y-1 sticky top-24">
                        {SIDEBAR_ITEMS.map((item) => (
                            <button
                                ...
                                className={`w-full text-left px-4 py-3 text-sm font-medium transition-all border-l-[3px] ${
                                    activeTab === item.id 
