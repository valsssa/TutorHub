...
import { Tutor, Session, User, UserRole, VerificationRequest, ChatThread, TutorStudent } from '../domain/types';
...
export const MOCK_TUTOR_STUDENTS: TutorStudent[] = [
    { id: '1', name: 'Lauren', type: 'Subscription', lessonsCompleted: 7, lessonsTotal: 8, nextLessonAt: '2024-10-27T10:00:00Z' },
    { id: '2', name: 'Luis P.', type: 'Subscription', lessonsCompleted: 4, lessonsTotal: 5, nextLessonAt: '2024-10-27T14:00:00Z' },
    { id: '3', name: 'Elodie C.', type: 'Cancelled', lessonsCompleted: 14, lessonsTotal: 14, nextLessonAt: '2024-10-28T16:00:00Z', suggestedAction: 'Message student' },
    { id: '4', name: 'Mauricio E.', type: 'Subscription', lessonsCompleted: 5, lessonsTotal: 5, nextLessonAt: '2024-11-01T09:00:00Z' },
