...
import { Tutor, User, ViewState } from '../domain/types';
...
export const PaymentPage: React.FC<PaymentPageProps> = ({ tutor, slot, currentUser, onBack, onConfirm, onNavigate }) => {
                    ...
                    <div className="lg:col-span-7 space-y-6">
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm">
                            ...
                            <div className="mt-4 text-xs text-slate-500 leading-relaxed text-center">
                                By pressing the "Book lesson and pay" button, you agree to <button onClick={() => onNavigate('cancellation-policy')} className="underline hover:text-slate-700 dark:hover:text-slate-300">Refund and Payment Policy</button>
                            </div>
